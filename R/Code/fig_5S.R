...
#CODE FOR: 16S and ITS NMDS plots of each site and their respective plants based upon microbial commmunity dissimilarity matrices. Ellipses are grouped by sample depth. 
...
mirador_NMDS <- ggplot(NMDS2, aes(x=MDS1, y=MDS2, fill=Plant, group= c(Sample_Depth))) +
...
#save NMDS plot
ggsave(filename="galapagos16S_alldepths_mirador_NMDS_oct22.pdf",
       device="pdf",path="./images/october",
       plot=mirador_NMDS,
       width=6,
       height=5,
       units="in",
...
cerro_A_NMDS <- ggplot(NMDS2, aes(x=MDS1, y=MDS2, fill=Plant, group= c(Sample_Depth))) +
  geom_point(mapping=aes(shape=as.factor(Sample_Depth)),
             size = 4, color="#008E51")+
  scale_shape_manual(values = c(23, 24, 22)) +
  stat_ellipse() +
...
#save plot
ggsave(filename="galapagos16S_Cerro_A_alldepths_NMDS_october22.pdf",
       device="pdf",path="./images/october",
       plot=cerro_A_NMDS,
       width=6,
       height=5,
...
eljunco_NMDS <- ggplot(NMDS2, aes(x=MDS1, y=MDS2, fill=Plant, group= c(Sample_Depth))) +
  geom_point(mapping=aes(shape=as.factor(Sample_Depth)),
             size = 4, color="#043FFF")+
  scale_shape_manual(values = c(23, 24, 22)) +
  stat_ellipse() +
...
#save plot
ggsave(filename="galapagos16S_eljunco_alldepths_NMDS_oct22.pdf",
       device="pdf",path="./images/october",
       plot=eljunco_NMDS,
       width=6,
       height=5,
...
#graph the data, grouping by Sample Depth
...
#save graph
ggsave(filename="02_NMDS_galapagos16S_Sample_Depth.pdf",
...
#save NMDS plot
ggsave(filename="galapagosITS_alldepths_mirador_NMDS_oct22.pdf",
       device="pdf",path="./images/october",
       plot=mirador_NMDS,
       width=6,
       height=5,
...
#save plot
ggsave(filename="galapagosITS_Cerro_A_alldepths_NMDS_october22.pdf",
       device="pdf",path="./images/october",
       plot=cerro_A_NMDS,
       width=6,
       height=5,
...
#save plot
ggsave(filename="galapagosITS_eljunco_alldepths_NMDS_oct22.pdf",
       device="pdf",path="./images/october",
       plot=eljunco_NMDS,
       width=6,
       height=5,
