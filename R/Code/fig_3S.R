...
##save image 
ggsave(filename="01_galapagos16S_stacked_phyla.pdf",
...
#set color palette
ord_col=c("grey", "#66c2a5","#fc8d62","#7570b3","#e78ac3","#a6d854","#ffd92f",
          "#6baed6","#fc9272","#238b45","#525252","#e7298a","#08589e",
          "#bf812d", "#771155", "#CC99BB", "#774411", "#DD7788", "lightgreen","coral", "pink", "yellow", "lightblue", "lightskyblue1", "slateblue1");
...
#set color palette
gen_col=c("grey", "#66c2a5","#fc8d62","#7570b3","#e78ac3","#a6d854","#ffd92f",
          "#6baed6","#fc9272","#238b45","#525252","#e7298a","#08589e",
...
#write file
write.csv(taxa_rel, file="data/01_Galapagos16S_genus.csv",row.names=F);
...
#write file
write.csv(taxa_rel, file="data/01_Galapagos16S_order.csv",row.names=F);
...
#write file
write.csv(taxa_rel, file="data/01_Galapagos16S_phyla.csv",row.names=F);
...
#write file
write.csv(taxa_rel, file="data/01_GalapagosITS_phyla.csv",row.names=F);
