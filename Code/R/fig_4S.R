## CODE FOR: generating NMDS plots for each site at all sample depths based on 16S microbial commmunity dissimilarity matrices. Ellipses grouped by plant within each site. 
